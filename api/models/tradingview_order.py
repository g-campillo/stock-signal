...
class TradingViewOrder:
    ...
    def __repr__(self) -> str:
        return f"<{self.__class__.__name__} ticker={self.ticker} action={self.action} contracts={self.contracts} position_size={self.position_size} interval={self.interval} close={self.close} time={self.time} price={self.price} market_position={self.market_position}>"